...
const ProductDetails = () => {
  ...
  const getSimilarProduct = async (pid, cid) => {
    try {
      const { data } = await axios.get(
        `https://ecommerce-u4ub.onrender.com/api/v1/product/related-product/${pid}/${cid}`
      );
    ...
    <Layout>
      <div className="row container product-details">
        <div className="col-md-6">
          <img
            src={`https://ecommerce-u4ub.onrender.com/api/v1/product/product-photo/${product._id}`}
