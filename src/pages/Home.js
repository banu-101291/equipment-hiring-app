...
//         "https://ecommerce-u4ub.onrender.com/api/v1/product/get-product"
//       );
//       setLoading(false);
//       setProducts(data?.products || []);
//     } catch (error) {
...
//       setLoading(true);
//       const { data } = await axios.get(
//         `https://ecomss.onrender.com/api/v1/product/product-list/${page}`
//       );
//       setLoading(false);
...
//         "https://ecomss.onrender.com/api/v1/product/product-filters",
//         {
//           checked,
//           radio,
//         }
...
//           <div className="d-flex flex-column">
//             <Radio.Group onChange={(e) => setRadio(e.target.value)}>
//               {/* Assuming Prices is an array of objects with _id, name, and array properties */}
//               {Prices?.map((p) => (
//                 <div key={p._id}>
//                   <Radio value={p.array}>{p.name}</Radio>
//                 </div>
